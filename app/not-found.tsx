...
import classes from "../components/modules/notFound.module.css";
      ...
      <div className={classes.inner}>
        ...
        <div className={classes.content}>
          ...
          >
            ...
            Bunun bir hata olduğunu düşünüyorsanız destek ekibiyle iletişime
            geçin.
          </Text>
          <Group justify="center">
            <Button size="md" component={Link} href={"/iletisim"}>
