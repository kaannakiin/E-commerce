...
const OrderPage = async (params: { searchParams: SearchParams }) => {
  ...
  const orderBy = (searchParams.sort as string) || "newest";
  const take = 10;
      ...
      <div className="mb-4 flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
        ...
        <div className="hidden items-center sm:block">
          <Text
            ...
            href={`/hesabim/siparislerim/${order.orderNumber}`}
            size="sm"
            className="font-semibold text-primary-500 transition-colors duration-200 hover:text-primary-700"
            font-semibold
            style={{
              textDecoration: "none",
              padding: "6px 12px",
