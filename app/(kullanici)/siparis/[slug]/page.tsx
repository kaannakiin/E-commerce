...
import CancelButton from "../../hesabim/siparislerim/_components/CancelButton";
import ReBuyButton from "../../hesabim/siparislerim/_components/ReBuyButton";
import RefundButton from "../../hesabim/siparislerim/_components/RefundButton";
      ...
      <div className="mt-4 grid w-full grid-cols-1 gap-4 lg:grid-cols-2">
        {data.OrderItems &&
          data.OrderItems.map((item, index) => (
            <div
              className="flex flex-row rounded-md border p-4 shadow-sm"
              key={index}
            >
              {item.variant.Image && (
