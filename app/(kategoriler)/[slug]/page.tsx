...
const page = async (props: { params: Params; searchParams: SearchParams }) => {
  ...
  return (
    <Fragment>
      ...
      />
      <div className="px-3 sm:px-6 md:px-8 lg:px-10 py-5 flex flex-col w-full">
        ...
        <div className="mt-6">
          {response.count > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6 w-full">
